...
SERVICE_NAME='web'  # default service name , see docke-compose.yml if you want to change this parameter
...
# docker run does not start the container, it will just create the container and execute on it the disired command
